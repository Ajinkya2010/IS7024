...
namespace Crime
{
    ...
    public partial class PoliceCrime
    {
    ...
    public enum HateBias { NNoBiasNotApplicable, The11AntiWhite, The33AntiOtherEthnicityNationalOrigin, The88DomesticViolence };

    public enum Opening { The1Door, The2Window, The3Garage, The6Unknown };

    public enum Side { The1Front, The2Side, The3Rear, The6Unknown };
    ...
    public enum Weapons { The11FirearmTypeNotStated, The12AAutomaticHandgun, The12Handgun, The13Rifle, The18BbAndPelletGuns, The20KnifeCuttingInstrumentIcepickAxEtc, The30BluntObjectClubHammerEtc, The35MotorVehicleWhenUsedAsWeapon, The40PersonalWeaponsHandsFeetTeethEtc, The80OtherWeapon, The99None, UUnknown };
    ...
    public partial class PoliceCrime
    {
        public static PoliceCrime[] FromJson(string json) => JsonConvert.DeserializeObject<PoliceCrime[]>(json, Crime.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this PoliceCrime[] self) => JsonConvert.SerializeObject(self, Crime.Converter.Settings);
    }
    ...
    internal class HateBiasConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case "33--ANTI-OTHER ETHNICITY/NATIONAL ORIGIN":
                    return HateBias.The33AntiOtherEthnicityNationalOrigin;
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                case HateBias.The11AntiWhite:
                    ...
                    return;
                case HateBias.The33AntiOtherEthnicityNationalOrigin:
                    serializer.Serialize(writer, "33--ANTI-OTHER ETHNICITY/NATIONAL ORIGIN");
                    return;
